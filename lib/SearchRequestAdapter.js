...
var SearchRequestAdapter = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(SearchRequestAdapter, [{
    ...
    value: function _adaptFacetFilters(facetFilters) {
      ...
      var transformedTypesenseFilters = facetFilters.map(function (item) {
        if (Array.isArray(item)) {
          ...
          var typesenseFilterString = "".concat(fieldName, ":=[").concat(fieldValues.map(_this._escapeFacetValue).join(","), "]");
          ...
          var _typesenseFilterString = "".concat(_fieldName, ":=[").concat(_this._escapeFacetValue(fieldValue), "]");
    ...
    key: "_adaptGeoFilter",
    value: function _adaptGeoFilter(boundingBox) {
      var _boundingBox$split = boundingBox.split(","),
          _boundingBox$split2 = (0, _slicedToArray2["default"])(_boundingBox$split, 4),
          x1 = _boundingBox$split2[0],
          y1 = _boundingBox$split2[1],
          x2 = _boundingBox$split2[2],
          y2 = _boundingBox$split2[3];
    ...
    key: "_adaptFilters",
    value: function _adaptFilters(facetFilters, numericFilters, geoFilter) {
      var adaptedFilters = [];
