  ...
  (0, _createClass2.default)(SearchRequestAdapter, [
    {
      ...
      value: function _adaptFacetFilters(facetFilters) {
        ...
        facetFilters.flat().forEach(function(facetFilter) {
          ...
          var _facetFilter$split2 = (0, _slicedToArray2.default)(
            _facetFilter$split,
            2
          );
          var facetName = _facetFilter$split2[0];
          var facetValue = _facetFilter$split2[1];
    ...
    },
    {
      ...
      facetFilters.flat().forEach(function (facetFilter) {
        var _facetFilter$split = facetFilter.split(new RegExp("(?<!:):(?!:)")),
    ...
    },
    {
      ...
      value: function _buildSearchParameters() {
        ...
        for (
          var _i = 0,
            _Object$entries = Object.entries(this.additionalSearchParameters);
        ...
        var typesenseSearchParams = Object.assign(
          {},
          snakeCasedAdditionalSearchParameters
        );
        ...
        if (params.facetQuery) {
          typesenseSearchParams.facet_query = ""
            .concat(params.facetName, ":")
            .concat(params.facetQuery);
                    ...
                    case 0:
                      return _context.abrupt(
                        ...
                        this.typesenseClient
                          .collections(
                            this._adaptIndexName(
                              this.instantsearchRequest.indexName
                            )
                          )
                          .documents()
