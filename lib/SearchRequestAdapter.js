  ...
  (0, _createClass2["default"])(SearchRequestAdapter, [{
    ...
    value: function _adaptFacetFilters(facetFilters) {
      ...
      facetFilters.flat().forEach(function (facetFilter) {
        var _facetFilter$split$re = facetFilter.split(":").reverse(),
            _facetFilter$split$re2 = (0, _toArray2["default"])(_facetFilter$split$re),
            facetValue = _facetFilter$split$re2[0],
            splitFacetNames = _facetFilter$split$re2.slice(1);

        var facetName = splitFacetNames.join(":");
