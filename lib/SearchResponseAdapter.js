    ...
    value: function _adaptHighlightResult(typesenseHit, snippetOrValue) {
      ...
      Object.entries(result).forEach(function (_ref4) {
        ...
        if (Array.isArray(value)) {
          ...
          result[attribute] = [];
          typesenseHit.document[attribute].forEach(function (valueFromArray, index) {
            if (matchedIndices && matchedIndices.includes(index)) {
              result[attribute].push({
                value: _this3._adaptHighlightTag("".concat(valueFromArray), _this3.instantsearchRequest.params.highlightPreTag, _this3.instantsearchRequest.params.highlightPostTag),
