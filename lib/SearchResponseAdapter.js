        ...
        if (Array.isArray(value)) {
          ...
          value.forEach(function (v) {
            result[attribute].push({
              value: _this3._adaptHighlightTag(_he["default"].decode("".concat(v)), _this3.instantsearchRequest.params.highlightPreTag, _this3.instantsearchRequest.params.highlightPostTag),
          ...
          result[attribute].value = _this3._adaptHighlightTag(_he["default"].decode("".concat(value)), _this3.instantsearchRequest.params.highlightPreTag, _this3.instantsearchRequest.params.highlightPostTag);
        }
      });
      return result;
    }
