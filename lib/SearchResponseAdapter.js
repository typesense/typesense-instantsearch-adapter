        ...
        if (Array.isArray(value)) {
          ...
          typesenseHit.document[attribute].forEach(function (unhighlightedValueFromArray, index) {
            if (matchedIndices && matchedIndices.includes(index)) {
              ...
              result[attribute].push({
                value: _this3._adaptHighlightTag("".concat(unhighlightedValueFromArray), _this3.instantsearchRequest.params.highlightPreTag, _this3.instantsearchRequest.params.highlightPostTag),
                matchLevel: "none",
                matchedWords: []
              });
            }
